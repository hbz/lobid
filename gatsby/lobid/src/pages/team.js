...
export default ({ data }) => {
    const contactPointContactType=data.dataJson.contactPoint[0].contactType.en
		const    makesOfferAlternateName0={data.dataJson.makesOffer[0].alternateName.en}
...
return (
  ...
  <Team
    ...
    contactPointContactType={contactPointContactType}
