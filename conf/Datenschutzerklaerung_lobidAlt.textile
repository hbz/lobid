...
*58* In "lobid-organisations(lobid-organisations)":http://lobid.org/organisations wird diese Datenverarbeitung genutzt, 
um Suchergebnisse nach Nähe zum Nutzer zu sortieren. Da diese unter der gleichen
Domain liegt, wird die Einverständnis automatisch abgefragt. Sie hat aber keine
Funktion in den Diensten, die auf diese Datenschutzerklärung verlinken. 
...
widerrufen werden. Wird der Browser bzw. das Fenster geschlossen, endet die
Browser-Session und die Standortdaten sind nicht mehr auf dem Rechner des
Nutzers gespeichert.
