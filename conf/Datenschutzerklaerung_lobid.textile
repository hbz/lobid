...
werden können, werden diese an jene weitergeleitet. Einen Tag nach der Korrektur
in der GND bzw. im Verbundkatalog sind die Daten in den lobid-Diensten aktualisiert.

h2. 9. Standortdaten

h3. 9.1 Beschreibung und Umfang der Datenverarbeitung

*56* Im Dienst lobid-organisations wird aufgrund der IP-Adresse der Standort 
geschätzt. Genutzt wird dafür die Browser-API von HTML5-fähigen Browsern.
